...
CURRENCY_MINOR_UNITS: dict[str, int] = {
    ...
    "HKD": 2, "HNL": 2, "HRK": 2, "HTG": 2, "HUF": 2, "IDR": 2,
    "ILS": 2, "INR": 2, "IRR": 2, "JMD": 2, "KES": 2, "KGS": 2,
    "KHR": 2, "KZT": 2, "LAK": 2, "LBP": 2, "LKR": 2, "LRD": 2,
    ...
    "UAH": 2, "USD": 2, "UYU": 2, "UZS": 2, "WST": 2, "YER": 2,
    "ZAR": 2, "ZMW": 2,
}
...
def to_minor_units(amount: Decimal, currency: str) -> int:
    ...
    if scaled != scaled.to_integral_value():
        raise CurrencyError(
            f"Amount {amount} has more than {units} decimal places for {currency}"
        )
    return int(scaled)
