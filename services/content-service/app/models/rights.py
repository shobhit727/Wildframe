...
class TerritorialLicense(Base):
    ...
    rights_holder_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), nullable=False, index=True)
    territory: Mapped[str] = mapped_column(String(10), nullable=False, index=True)  # US, EU, IN, GLOBAL
