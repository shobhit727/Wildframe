...
class ContentDSARRecord(Base):
    ...
    dsar_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), nullable=False, index=True)  # FK to user-service DSAR
    content_type: Mapped[str] = mapped_column(String(50), nullable=False)  # viewing_history, uploads, reviews, rights
