...
class CastMemberRepository(BaseRepository):
    ...
    async def create(self, name: str, slug: str, bio: str | None = None,
                    birth_date=None, image_url: str | None = None) -> CastMember:
...
class ContentRepository(BaseRepository):
    ...
    async def create(self, title: str, slug: str, description: str, content_type: ContentType,
                    release_date=None, duration_minutes: int | None = None,
                    original_language: str = 'en', country: str | None = None,
                    poster_url: str | None = None, backdrop_url: str | None = None,
                    trailer_url: str | None = None, imdb_rating: float | None = None,
                    content_rating: str | None = None, is_premium: bool = False,
...
class SeasonRepository(BaseRepository):
    ...
    async def create(self, content_id: UUID, season_number: int, title: str,
                    description: str | None = None, poster_url: str | None = None,
    ...
    async def get_by_content_and_number(self, content_id: UUID, season_number: int) -> Season | None:
...
class EpisodeRepository(BaseRepository):
    ...
    async def create(self, content_id: UUID, season_id: UUID, episode_number: int,
                    title: str, duration_minutes: int, description: str | None = None,
                    thumbnail_url: str | None = None, release_date=None,
...
class ContentRatingRepository(BaseRepository):
    ...
    async def create(self, content_id: UUID, user_id: UUID, rating: float,
                    review: str | None = None) -> ContentRating:
