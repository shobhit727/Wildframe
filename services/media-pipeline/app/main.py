...
def _fallback_lock() -> asyncio.Lock:
    ...
    The lifespan initialises ``_in_flight_lock``; requests arriving outside
    a lifespan-managed context (tests, misconfigured hosts) must not crash
    the middleware.
    """
