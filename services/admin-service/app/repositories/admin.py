...
class UserModerationRepository:
    ...
    async def create(self, user_id: str, status: str, reason: str | None, moderated_by: str) -> UserModeration:
    ...
    async def list_moderated_users(self, status: str | None = None, limit: int = 50, offset: int = 0) -> list[UserModeration]:
    ...
    async def update_status(self, user_id: str, status: str, reason: str | None, moderated_by: str) -> UserModeration | None:
...
class ContentModerationRepository:
    ...
    async def create(self, content_id: str, content_type: str, status: str, reason: str | None, flagged_by: str | None = None) -> ContentModeration:
    ...
    async def update_status(self, content_id: str, status: str, resolved_by: str) -> ContentModeration | None:
...
class SystemConfigRepository:
    ...
    async def create(self, key: str, value: str, config_type: str, description: str | None, updated_by: str) -> SystemConfig:
...
class AdminAuditLogRepository:
    ...
    async def create(self, admin_id: str, action: str, resource_type: str, resource_id: str, changes: str | None, ip_address: str) -> AdminAuditLog:
