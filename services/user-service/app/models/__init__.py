...
class UserPreference(Base):
    ...
    default_video_quality = Column(String(20), default="adaptive")  # "adaptive", "720p", "1080p", "4k"
...
class UserSubscriptionProfile(Base):
    ...
    subscription_status = Column(String(50), default="active")  # "active", "inactive", "suspended", "canceled"
