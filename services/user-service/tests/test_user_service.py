...
class TestSessionManagement:
    ...
    async def test_get_active_sessions(self, user_service, user_id, mock_repositories):
        ...
        mock_repositories["session_repo"].list_active_sessions.return_value = [mock_session1, mock_session2]
...
class TestWatchHistory:
    ...
    async def test_get_watch_history(self, user_service, user_id, mock_repositories):
        ...
        mock_repositories["history_repo"].get_watch_history.return_value = ([mock_entry1, mock_entry2], 2)
